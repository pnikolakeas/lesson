...
public class LinksGridItem extends BasicGridItem {

	public LinksGridItem(String text, TreePanelDropTargetExtended dropTarget) {
		super(text);
	...
	protected List<ColumnConfig> initColumnConfigs() {
		...
		column = new ColumnConfig("url", "URL", 276);
		column.setEditor(new CellEditor(text));
		configs.add(column);
